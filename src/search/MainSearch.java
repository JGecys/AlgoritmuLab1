...
public class MainSearch {
    ...
    public static void main(String[] args) throws IOException {
        List<Student> generate = generate(1000);
...
//        DataItem dataItem = table.find(LASTNAMES[new Random().nextInt(LASTNAMES.length)].hashCode());
//        System.out.println(dataItem.getValue().toString());
    }
